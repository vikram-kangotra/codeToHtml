    ...
    public:
        ...
        std::string getTypeStr() const {
            switch(mType) {
                ...
                case TokenType::CHARACTER:              return "Character"; break;
                case TokenType::SPACE:                  return "Space"; break;
                case TokenType::NEWLINE:                return "Newline"; break;
                case TokenType::HASH:                   return "Hash"; break;
                case TokenType::COLON:                  return "Colon"; break;
                case TokenType::SEMICOLON:              return "SemiColon"; break;
                case TokenType::AMPERSAND:              return "Ampersand"; break;
                case TokenType::DOT:                    return "Dot"; break;
                case TokenType::COMMA:                  return "Comma"; break;
                case TokenType::NOT:                    return "Not"; break;
                case TokenType::LEFT_CURLY_PARENTHESIS: return "Left Curly Parentthesis"; break;
                case TokenType::RIGHT_CURLY_PARENTHESIS:return "Right Curly Parentthesis"; break;
                case TokenType::LEFT_BOX_PARENTHESIS:   return "Left Box Parentthesis"; break;
                case TokenType::RIGHT_BOX_PARENTHESIS:  return "Right Box Parentthesis"; break;
                case TokenType::UNKNOWN:                return "Unkown"; break;
            }
            return "Unknown";
        }
